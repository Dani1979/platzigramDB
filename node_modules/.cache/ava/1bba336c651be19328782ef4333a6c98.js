...
test.after('disconnect databese', (() => {
  var _ref2 = _asyncToGenerator(function* (t) {
    var _rec2 = new _powerAssertRecorder();

    yield db.disconnect();
    t.false(_rec2._expr(_rec2._capt(_rec2._capt(db, 'arguments/0/object').connection, 'arguments/0'), {
      content: 't.false(db.connection, \'should be disconneted\')',
      filepath: 'test/db-test.js',
      line: 19,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"db","range":[8,10]},"property":{"type":"Identifier","name":"connection","range":[11,21]},"computed":false,"range":[8,21]},{"type":"StringLiteral","value":"should be disconneted","range":[23,46]}],"range":[0,47]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"db","range":[8,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"connection","range":[11,21]},{"type":{"label":","},"range":[21,22]},{"type":{"label":"string"},"value":"should be disconneted","range":[23,46]},{"type":{"label":")"},"range":[46,47]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'should be disconneted');
  });
...
//# sourceMappingURL=../node_modules/.cache/ava/1bba336c651be19328782ef4333a6c98.js.map