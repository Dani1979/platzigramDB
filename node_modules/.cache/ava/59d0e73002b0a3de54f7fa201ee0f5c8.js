...
test('save image', (() => {
  var _ref4 = _asyncToGenerator(function* (t) {
    ...
    let image = {
      description: 'an #awasome picture whith #tags from #platzi',
      url: `https://platzigram.test/${uuid.v4()}`,
      likes: 0,
      liked: false,
      userId: uuid.uuid()
    };
...
//# sourceMappingURL=../node_modules/.cache/ava/59d0e73002b0a3de54f7fa201ee0f5c8.js.map