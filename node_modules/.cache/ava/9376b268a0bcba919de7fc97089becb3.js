...
//   await db.disconnect()
//   t.false(db.connection, 'should be disconneted')
// })

test.after.always('cleanup database', (() => {
  var _ref2 = _asyncToGenerator(function* (t) {
    let conn = yield t.connect({});
    yield t.dbDrop(dbName).run(conn);
  });
...
//# sourceMappingURL=../node_modules/.cache/ava/9376b268a0bcba919de7fc97089becb3.js.map