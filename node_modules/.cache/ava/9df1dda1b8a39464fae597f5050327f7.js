...
test('Get Image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    t.throws(_avaThrowsHelper(function () {
      ...
      filename: '/Users/Casa/Documents/Web/platzigram/platzigramDB/test/db-test.js'
    }), /not found/);
  });
...
test('authenticate user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    t.true(_rec5._expr(_rec5._capt(success, 'arguments/0'), {
    ...
    let fail = yield db.authenticate(user.username, 'fooo');
    t.false(_rec6._expr(_rec6._capt(fail, 'arguments/0'), {
    ...
    t.false(_rec7._expr(_rec7._capt(failure, 'arguments/0'), {
...
//# sourceMappingURL=../node_modules/.cache/ava/9df1dda1b8a39464fae597f5050327f7.js.map